...
public class BlockchainIntegration : MonoBehaviour
{
    ...
    public async void StartLoginMetamask()
    {
        ...
        if (skipLogin)
        {
            PlayerPrefs.SetString("TokenJWT", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..58F_oP8O-FK9ejHWUG5XTbMYxZoOTN7iQ00-dcjeacE");
